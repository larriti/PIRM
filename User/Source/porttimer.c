...
/* ----------------------- Defines ------------------------------------------*/
#define MB_TIMER_DEV            ( TIM3 )
#define MB_TIMER_RCC            ( RCC_APB1Periph_TIM3 )
#define MB_TIMER_IRQ_CH         ( TIM3_IRQn )
#define MB_TIMER_IRQ_HANDLER    ( TIM3_IRQHandler )
